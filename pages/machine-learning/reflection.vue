...
I learned to partition training data effectively, separating a validation set to monitor model generalisation. I tuned hyperparameters like batch size, learning rate, and optimizer, guided by Zhao et al. (2023), who emphasize the interpretability-performance trade-off in deep learning. Data augmentation techniques were applied to mitigate overfitting—transforming not just images, but my perception of how preprocessing can shape model success.
...
In the Unit 6 Airbnb project, I led Zoom meetings, managed communication via WhatsApp, and coordinated collaborative coding in Google Colab. I learned to balance assertiveness with open listening. Feedback from peers helped refine our business question and improve model interpretation. Through these experiences, I improved my ability to lead in distributed environments—a key competency for hybrid work settings (Mann & Holdsworth, 2022).
