import _ from"./B-oz9iPE.js";import{_ as S}from"./DceuJfE7.js";import{r as w,e as v,g as T,h as P,o as i,c as n,F as b,i as f,f as d,a as e,t as y,b as g,j as k,w as A,k as x,d as C}from"./CHh-_m52.js";import{_ as z}from"./CNT_xS2t.js";import{u as D}from"./LmwxMc5R.js";function q(){const r=w(0),t=w(!1);function c(a){r.value=a,t.value=!0}function s(){t.value=!1}return{visibleRef:t,indexRef:r,showImg:c,onHide:s}}const N={class:"flex flex-col gap-4"},E=["onClick"],L=["src","alt"],R={class:"text-sm py-2 px-4"},j=v({__name:"AppLightBox",props:{images:{}},setup(r){const t=r,{visibleRef:c,indexRef:s,showImg:a,onHide:u}=q(),p=T(()=>t.images.map(l=>`/images/${l.src}`));return(l,o)=>{const h=P("VueEasyLightbox");return i(),n("div",N,[(i(!0),n(b,null,f(t.images,(m,I)=>(i(),n("div",{key:m,class:"rounded-lg shadow border border-gray-200 overflow-hidden cursor-pointer hover:scale-105 transition-all duration-300",onClick:()=>d(a)(I)},[e("img",{src:`/images/${m.src}`,alt:m.alt,class:"w-full border-b border-gray-200"},null,8,L),e("div",R,y(m.alt),1)],8,E))),128)),g(h,{visible:d(c),imgs:d(p),index:d(s),onHide:d(u)},null,8,["visible","imgs","index","onHide"])])}}}),O={class:"grid grid-cols-12 gap-12 py-8"},B={class:"md:col-span-8"},F={class:"flex items-center gap-2 mb-4 sticky top-0 bg-white pt-10 pb-4"},$={class:"text-xl font-semibold text-green-500"},H={class:"md:col-span-4"},Q={class:"sticky top-16"},V={key:0,class:"bg-green-100 rounded-2xl p-6 border border-green-300 border-dashed"},U={class:"list-disc text-gray-700 px-6 text-sm space-y-2"},M={key:1,class:"mt-4"},W=v({__name:"AppPortfolioSection",props:{title:{},content:{},images:{},keyInsights:{}},setup(r){const t=r;return(c,s)=>{const a=_,u=S,p=j;return i(),n("div",O,[e("div",B,[e("div",F,[g(a,{name:"mdi:bookmark",class:"text-green-500"}),e("h3",$,y(c.title),1)]),g(u,{content:t.content},null,8,["content"])]),e("div",H,[e("div",Q,[t.keyInsights?(i(),n("div",V,[s[0]||(s[0]=e("p",{class:"text-gray-700 font-semibold mb-2 text-sm"}," Key Insights: ",-1)),e("ul",U,[(i(!0),n(b,null,f(t.keyInsights,l=>(i(),n("li",{key:l},y(l),1))),128))])])):k("",!0),t.images?(i(),n("div",M,[s[1]||(s[1]=e("p",{class:"font-semibold mb-2"}," Images ",-1)),g(p,{images:t.images},null,8,["images"])])):k("",!0)])])])}}});function G(){return{activities:[{title:"Collaborative Discussions",images:[{src:"/deciphering-big-data/collaborative-discussions/1.png",alt:"Initial Post"},{src:"/deciphering-big-data/collaborative-discussions/2.png",alt:"Lecturer Feedback"},{src:"/deciphering-big-data/collaborative-discussions/3.png",alt:"Follow-Up Contributions"}],content:`The joint discussion forums made a significant contribution to promoting a deeper understanding of critical data science concepts. Each forum offered the opportunity to exchange findings, respond to colleagues and get valuable feedback from tutors. One of the examined key topics was the integration of IoT into data science. Williams (2024) underlines the value of teamwork in promoting problem solving and the exchange of knowledge.
...
-   Gained insights into real-world applications of IoT, particularly in managing large datasets for analytics.
    `}],technicalActivities:[{title:"Normalization Task",images:[{src:"/deciphering-big-data/normalization-task/1.png",alt:"Python code for normalization"},{src:"/deciphering-big-data/normalization-task/2.png",alt:"Student's table"},{src:"/deciphering-big-data/normalization-task/3.png",alt:"Courses table"},{src:"/deciphering-big-data/normalization-task/4.png",alt:"Course Exam Boards table"}],keyInsights:["The normalization process is essential for designing scalable databases.","Understanding dependencies and relationships between data attributes is critical for eliminating redundancy.","Normalization ensures data integrity and consistency, aligning with principles outlined by Batini and Scannapieco (2016)"],content:`**Detailed Steps**:
...
`},{title:"Web Scraping Task",images:[{src:"/deciphering-big-data/web-scraping/1.png",alt:"Python code for web scraping"},{src:"/deciphering-big-data/web-scraping/2.png",alt:"JSON file for web scraping"}],keyInsights:["Web scraping is a powerful technique for automating data collection but requires careful consideration of website policies and restrictions.","Structuring data from unstructured sources requires both technical proficiency and logical problem-solving."],content:`**Objective**:  
...
**Outcome**:  
The script successfully automated the extraction of over 15 job postings, providing clean and structured data suitable for analysis. The task highlighted my ability to handle unstructured web data and transform it into valuable insights.`},{title:"Database Build Task",images:[{src:"/deciphering-big-data/database-build/1.png",alt:"SQL script for create tables"},{src:"/deciphering-big-data/database-build/2.png",alt:"SQL script for populate tables"},{src:"/deciphering-big-data/database-build/3.png",alt:"SQL script for test queries"},{src:"/deciphering-big-data/database-build/4.png",alt:"Students table"},{src:"/deciphering-big-data/database-build/5.png",alt:"Courses table"},{src:"/deciphering-big-data/database-build/6.png",alt:"Teachers table"}],keyInsights:["Proper normalization ensures data consistency and reduces redundancy.","Testing and validating relationships are critical for database reliability.","Indexing and optimization improve performance in large datasets.","Kleppmann (2017) emphasizes the importance of scalability and reliability in database-intensive applications."],content:`**Objective:**  
...
**Outcome:**  
The database was fully functional and adhered to 3NF principles with optimized queries and robust relationships. The project showed the opportunity to design scalable databases for real applications. This design approach reflects best practice for relational databases that were highlighted by Chen (2023).`},{title:"API Security Evaluation",images:[{src:"/deciphering-big-data/api-security-evaluation/1.png",alt:"API Security Requirements Spec 1"},{src:"/deciphering-big-data/api-security-evaluation/2.png",alt:"API Security Requirements Spec 2"}],keyInsights:["Security is a continuous process that evolves with new threats and vulnerabilities.","The combination of proactive measurements (e.g. installment limitation) with reactive measures (e.g. logging and monitoring) improves the API resilience.",'The article "Data protection and data protection in the digital age: new trends and technologies" (2023) underlines the importance of coping with newly occurring risks in data protection, including secure API design and compliance with developing regulatory framework.'],content:`**Objective**:  
...
**Outcome**:  
Formed a safe and scalable API design with documented protocols and compliance with the best practices in the industry. The project has shown my ability to integrate security measures into the API development and to focus on the organizational requirements.`}]}}const K={class:"divide-y divide-gray-200 flex flex-col"},J={class:"space-y-4 divide-y divide-gray-200"},Z={class:"mt-10"},ae=v({__name:"artefacts-and-activities",setup(r){D({title:"Artefacts and Activities - Deciphering Big Data - E-Portfolio"});const{activities:t,technicalActivities:c}=G();return(s,a)=>{const u=W,p=_,l=z;return i(),n("div",null,[e("section",null,[a[0]||(a[0]=e("h2",{class:"text-3xl font-semibold mb-6"}," Artefacts and Activities ",-1)),e("div",K,[(i(!0),n(b,null,f(d(t),(o,h)=>(i(),x(u,{key:h,title:o.title,images:o.images,content:o.content},null,8,["title","images","content"]))),128))]),a[1]||(a[1]=e("p",{class:"bg-gray-100 rounded-2xl px-6 py-4 my-10 font-semibold text-gray-800 tracking-widest border border-gray-300 border-dashed"}," TECHNICAL ACTIVITIES ",-1)),e("div",J,[(i(!0),n(b,null,f(d(c),(o,h)=>(i(),x(u,{key:h,title:o.title,content:o.content,"key-insights":o.keyInsights,images:o.images},null,8,["title","content","key-insights","images"]))),128))])]),e("section",Z,[g(l,{to:"/deciphering-big-data/professional-skills-matrix-and-action-plan",class:"flex items-center gap-2 bg-green-50 rounded-lg px-4 py-4 hover:border-green-500 hover:text-green-500 border border-gray-300 border-dashed text-gray-700"},{default:A(()=>[g(p,{name:"ph:bookmark",class:"size-6 text-green-500"}),a[2]||(a[2]=e("span",null,[C("Next: "),e("span",{class:"font-semibold"},"Professional Skills Matrix and Action Plan")],-1))]),_:1})])])}}});export{ae as default};
